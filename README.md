...
You can also see [Java](https://github.com/starlangsoftware/TurkishPropBank), [Python](https://github.com/starlangsoftware/TurkishPropBank-Py), or [C#](https://github.com/starlangsoftware/TurkishPropBank-CS) repository.
